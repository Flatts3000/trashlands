...
- **Quests and teams:** FTB Quests, FTB Library, FTB Chunks, FTB Teams, FTB Essentials, FTB XMod
  Compat.
- **Vein mining:** FTB Ultimine. Blocks of Garbage, the mound ground, the ground itself and every
  other salvage pile are excluded from it on purpose - the junkyard is dug by hand, and so is the
  rock under it. Trees, crops and anything you built are not.
- **Scripting:** KubeJS.
