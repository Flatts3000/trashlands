...
| **FTB Quests** | The design's named quest engine, and the vehicle the narrative rides on. **Welcome**, **Salvage** and **Groundwork** ship as of v0.6.0, 41 quests. **The Depths** adds nineteen more for the Nether and is written but not yet released, taking the book to 61, from the first Block of Garbage to a piece of coal. |
