...
## Next actions
1. **Playtest v0.10.0.** Nothing in the last two releases has been launched by a person. The pack
   ...
   three Recompile majors. Specific things that need eyes: that the Simple Magnets recipes show
