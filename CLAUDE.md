...
**Status: alpha, shipping (v0.6.0, 2026-08-17).** The pack is **assembled and pinned** - 47 mods, MC 26.1.2 / NeoForge 26.1.2.94 - and the tag-driven release pipeline is in (`.github/workflows/release.yml` -> GitHub release + CurseForge upload). CurseForge project **`1636627`**, slug `trashlands`; `CF_PROJECT_ID` and `CF_API_TOKEN` are set on the repo. Recompile is at v0.10.0 and released on CurseForge (project `1625740`).
